...
Public Class frmAddContactvb
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Dim InsertQuery As String = "INSERT INTO [Advisory Board] ([Last Name], [First Name], [Title], [Company], [E-mail Address], [Business Phone]) VALUES (@lname,@fname,@title,@company,@email,@phone)"
        ...
        Dim name As String = "Advisory Board"
